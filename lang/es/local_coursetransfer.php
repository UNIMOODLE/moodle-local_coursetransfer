...
$string['target_target_is_incorrect'] = "Destination Target es incorrecto, debe tener valores 2,3 o 4: --target_target=2";
$string['origin_course_id_integer'] = "Origin Course ID tiene que ser entero: --origin_course_id=12";
$string['target_course_id_is_required'] = "Destination Course ID es obligatorio: --target_course_id=12";
$string['target_course_id_isnot_correct'] = "Para target_target=2 no debe tener curso de destino, se creará nuevo curso";
$string['target_category_id_integer'] = "Destination Category ID tiene que ser entero: --target_category_id=101";
$string['origin_enrolusers_boolean'] = "Origin Enrol Users tiene que ser boolean: --origin_enrolusers=true";
$string['target_remove_enrols_boolean'] = "Destination Remove Enrols tiene que ser boolean: --target_remove_enrols=false";
$string['target_remove_groups_booelan'] = "Destination Remove Groups tiene que ser boolean: --target_remove_groups=false";
...
$string['target_not_remove_activities_invalid'] = "Destination Not Remove Activities tiene que ser una cadena de cmid separados por coma de tipo array: --target_not_remove_activities=[3,234,234]";
