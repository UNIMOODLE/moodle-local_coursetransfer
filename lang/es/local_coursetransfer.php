...
$string['coursetransfer:view_logs'] = 'Ver logs de las peticiones';
$string['restore_courses_hidden'] = 'Restaurar cursos ocultos';
$string['restore_courses_hidden_desc'] = 'Si está activo, los cursos ocultos podrán ser enviados a la plataforma de destino. <strong>Nota: </strong> Recuerda que el rol de Course Transfer tiene que tener habilitado el permiso: moodle/course:viewhiddencourses';
$string['step2_course_visible'] = '¿Es visible?';
$string['visible'] = 'Visible';
$string['hidden'] = 'Oculto';
$string['courses_categories'] = 'Cursos y categoriás';
