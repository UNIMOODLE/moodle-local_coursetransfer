...
$string['destiny_target_is_incorrect'] = "Destination Target es incorrecto, debe tener valores 2,3 o 4: --destiny_target=2";
$string['origin_course_id_integer'] = "Origin Course ID tiene que ser entero: --origin_course_id=12";
$string['destiny_course_id_is_required'] = "Destination Course ID es obligatorio: --destiny_course_id=12";
$string['destiny_course_id_isnot_correct'] = "Para destiny_target=2 no debe tener curso de destino, se creará nuevo curso";
$string['destiny_category_id_integer'] = "Destination Category ID tiene que ser entero: --destiny_category_id=101";
$string['origin_enrolusers_boolean'] = "Origin Enrol Users tiene que ser boolean: --origin_enrolusers=true";
$string['destiny_remove_enrols_boolean'] = "Destination Remove Enrols tiene que ser boolean: --destiny_remove_enrols=false";
$string['destiny_remove_groups_booelan'] = "Destination Remove Groups tiene que ser boolean: --destiny_remove_groups=false";
...
$string['destiny_not_remove_activities_invalid'] = "Destination Not Remove Activities tiene que ser una cadena de cmid separados por coma de tipo array: --destiny_not_remove_activities=[3,234,234]";
...
$string['destiny_site'] = "Sitio destino";
$string['id'] = "ID";
...
$string['log_page_destiny_target'] = "Target de destino";
$string['log_page_petition_type'] = "Tipo de petición";
$string['log_page_direction'] = "Dirección";
$string['log_page_destiny_request'] = "Petición de Destino";
$string['log_page_request_category'] = "Petición Categoría";
$string['log_page_destiny_data'] = "Datos destino";
...
$string['in_target_adding_not_remove_enrols'] = 'No se pueden borrar matriculaciones en destino, cuando el target es una fusión de contenido (--destiny_target=4)';
$string['in_target_adding_not_remove_groups'] = 'No se pueden borrar grupos en destino, cuando el target es una fusión de contenido (--destiny_target=4)';
