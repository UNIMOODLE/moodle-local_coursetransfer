...
$string['setting_origin_sites_desc'] = 'List of source sites, from which backup copies of the courses may be requested. Perform a test to verify that everything is configured correctly, both at destination and origin.';
...
$string['destiny_target_is_incorrect'] = "Destination Target is incorrect, must have values 2,3 or 4";
...
$string['destiny_category_id_integer'] = "Destination Category ID must be an integer";
$string['origin_enrolusers_boolean'] = "Origin Enrol Users must be a boolean";
$string['destiny_remove_enrols_boolean'] = "Destination Remove Enrols must be a boolean";
$string['destiny_remove_groups_booelan'] = "Destination Remove Groups must be a boolean";
...
$string['destiny_not_remove_activities_invalid'] = "Destination Not Remove Activities must be a string separated by commas";
