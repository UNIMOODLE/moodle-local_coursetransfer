...
$string['setting_target_sites'] = 'Destination sites';
$string['setting_target_sites_link'] = 'Destination sites Management';
$string['setting_target_sites_desc'] = 'List of destination sites, to which the backup copies of the courses can be delivered. Perform a test to verify that everything is configured correctly, both at destination and origin.';
...
$string['target_target_is_incorrect'] = "Destination Target is incorrect, must have values 2,3 or 4: --target_target=2";
$string['origin_course_id_integer'] = "Origin Course ID must be an integer: --origin_course_id=12";
$string['target_course_id_is_required'] = "Destination Course ID is required: --target_course_id=12";
$string['target_course_id_isnot_correct'] = "For target_target=2 there must be no target course, a new course will be created";
$string['target_category_id_integer'] = "Destination Category ID must be an integer: --target_category_id=101";
$string['origin_enrolusers_boolean'] = "Origin Enrol Users must be a boolean: --origin_enrolusers=true";
$string['target_remove_enrols_boolean'] = "Destination Remove Enrols must be a boolean: --target_remove_enrols=false";
$string['target_remove_groups_booelan'] = "Destination Remove Groups must be a boolean: --target_remove_groups=false";
...
$string['target_not_remove_activities_invalid'] = "Destination Not Remove Activities must be a string separated by commas array type: --target_not_remove_activities=[3,234,234]";
...
$string['target_course_id'] = "Destination Course ID";
...
$string['target_course_id_integer'] = "Destination Course ID is integer";
$string['target_category_id_require'] = "Destination Category ID is required";
$string['target_category_id_integer'] = "Destination Category ID is integer";
$string['not_activities'] = "No Activities found";
$string['not_courses'] = "No courses found";
$string['request_not_found'] = "Request not found";
$string['deleteintarget'] = "Remove in destination";
$string['config_target_merge_activities_desc'] = "The activities of the origen course will be merged into the destination course";
$string['config_target_remove_activities_desc'] = "All content in the destination course will be deleted and restored with the origen course";
$string['config_target_remove_groups_desc'] = "Existing destination course groups and groupings will be deleted";
...
$string['step2_course_target'] = "Destination Course";
...
$string['step4_target_title'] = "Destination category";
$string['step4_target_desc'] = "Select the destination category of the restore";
...
$string['target_site'] = "Destination Site";
$string['id'] = "ID";
...
$string['log_page_target_target'] = "Destination target";
$string['log_page_petition_type'] = "Request type";
$string['log_page_direction'] = "Direction";
$string['log_page_target_request'] = "Destination request";
$string['log_page_request_category'] = "Request category";
$string['log_page_target_data'] = "Destination data";
...
$string['notification_restore_course_completed'] = 'The restoration of the remote course at your destination has been successfully completed: {$a}';
$string['notification_restore_category_completed'] = 'The restoration of the remote category at your destination has been successfully completed: {$a}';
