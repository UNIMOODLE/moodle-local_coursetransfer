...
$string['destiny_not_remove_activities_string'] = "Remove Activities must be a string";
...
$string['step4_restore_origin_site'] = "Origin Site";
$string['step4_restore_selected_course'] = "Selected Course";
$string['step4_details_shortname'] = "Short Name";
$string['step4_details_course_id'] = "Course ID Number";
$string['step4_details_category_name'] = "Category Name";
$string['step4_details_category_id'] = "Category ID";
$string['step4_details_backup_size'] = "Backup Estimated Size";
$string['step4_config_destiny_merge_activities'] = "Merge with destiny course";
$string['step4_config_destiny_remove_enrols'] = "Delete enrollments in destiny course";
$string['step4_config_destiny_remove_groups'] = "Delete groups in destiny course";
$string['step4_config_destiny_remove_activities'] = "Delete activities in destiny course";
