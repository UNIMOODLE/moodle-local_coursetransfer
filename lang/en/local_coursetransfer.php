...
$string['setting_destiny_sites_desc'] = 'List of destination sites, to which the backup copies of the courses can be delivered.';
$string['setting_origin_sites'] = 'Origin sites';
$string['setting_origin_sites_link'] = 'Origin sites Management';
$string['setting_origin_sites_desc'] = 'List of source sites, from which backup copies of the courses may be requested.';
