...
$string['setting_destiny_restore_course_max_size'] = "Grandària màxima del curs a restaurar (MB)";
$string['setting_destiny_restore_course_max_size_desc'] = "Límit a la mida de la còpia de seguretat (arxiu MBZ) del curs origen a restaurar a MB.";
$string['setting_destiny_sites'] = "Llocs destinació";
$string['setting_destiny_sites_link'] = "Gestió de Llocs destinació";
$string['setting_destiny_sites_desc'] = "Llistat de llocs destí, als quals se'ls podrà lliurar les còpies de seguretat dels cursos. Realitza una prova per comprovar que tot està configurat correctament, tant a destinació com a origen.";
...
$string['destiny_target_is_incorrect'] = "Destiny Target és incorrecte, ha de tenir valors 2,3 o 4: --destiny_target=2";
$string['origin_course_id_integer'] = "Origin Course ID ha de ser sencer: --origin_course_id=12";
$string['destiny_course_id_is_required'] = "Destiny Course ID és obligatori: --destiny_course_id=12";
$string['destiny_course_id_isnot_correct'] = "Per a destiny_target=2 no heu de tenir curs de destinació, es crearà nou curs";
$string['destiny_category_id_integer'] = "Destiny Category ID ha de ser sencer: --destiny_category_id=101";
$string['origin_enrolusers_boolean'] = "Origin Enrol Users ha de ser boolean: --origin_enrolusers=true";
$string['destiny_remove_enrols_boolean'] = "Destiny Remove Enrols ha de ser boolean: --destiny_remove_enrols=false";
$string['destiny_remove_groups_booelan'] = "Destiny Remove Groups ha de ser boolean: --destiny_remove_groups=false";
...
$string['destiny_not_remove_activities_invalid'] = "Destiny Not Remove Activities ha de ser una cadena de cmid separats per coma de tipus array: --destiny_not_remove_activities=[3,234,234]";
...
$string['destiny_course_id'] = "ID del curs de destinació";
$string['status'] = "Estat";
...
$string['config_destiny_merge_activities'] = "Fusionar la còpia de seguretat amb aquest curs";
$string['config_destiny_remove_enrols'] = "Eliminar rols i matriculacions al curs de destinació";
$string['config_destiny_remove_groups'] = "Eliminar grups i agrupaments al curs de destinació";
$string['config_destiny_remove_activities'] = "Esborrar el contingut del curs actual i després restaurar";
...
$string['destiny_course_id_integer'] = "ID Curs de Destinació ha de ser sencer";
$string['destiny_category_id_require'] = "ID Categoria de Destinació és obligatòria";
$string['destiny_category_id_integer'] = "ID Categoria de Destinació ha de ser sencer";
...
$string['deleteindestiny'] = "Esborrar en destinació";
$string['config_destiny_merge_activities_desc'] = "Les activitats del curs d'origen es fusionaran al curs de destinació";
$string['config_destiny_remove_activities_desc'] = "Tot el contingut del curs de destinació s'esborrarà i es restaurarà amb el curs d'origen";
$string['config_destiny_remove_groups_desc'] = "S'esborraran els grups i agrupaments actuals del curs de destinació ja existents";
$string['config_destiny_remove_enrols_desc'] = "S'esborraran les matriculacions i rols actuals del curs de destinació ja existents";
...
$string['step2_course_destiny'] = "Curs de Destinació";
...
$string['step4_destiny_title'] = "Categoria de destinació";
$string['step4_destiny_desc'] = "Seleccioneu la categoria de destinació de la restauració";
...
$string['destiny_site'] = "Lloc destinació";
$string['id'] = "ID";
...
$string['log_page_destiny_target'] = "Target de destinació";
$string['log_page_petition_type'] = "Tipus de petició";
$string['log_page_direction'] = "Direcció";
$string['log_page_destiny_request'] = "Petició de Destinació";
$string['log_page_request_category'] = "Petició Categoria";
$string['log_page_destiny_data'] = "Dades destí";
...
$string['coursetransfer:destiny_restore_enrol_remove'] = "Eliminar rols i matriculacions al curs de destinació";
$string['coursetransfer:destiny_restore_groups_remove'] = "Eliminar grups i agrupaments al curs de destinació";
$string['coursetransfer:destiny_restore_content_remove'] = "Esborrar el contingut del curs actual i després restaurar";
$string['coursetransfer:destiny_restore_merge'] = "Fusionar la còpia de seguretat amb aquest curs";
