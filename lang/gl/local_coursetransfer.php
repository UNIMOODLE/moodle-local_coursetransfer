...
$string['setting_destiny_restore_course_max_size']="Tamaño máximo do curso para restaurar (MB)";
$string['setting_destiny_restore_course_max_size_desc']="Limite o tamaño da copia de seguridade (ficheiro MBZ) do curso de orixe que se restaurará en MB.";
$string['setting_destiny_sites']="Sitios de destino";
$string['setting_destiny_sites_link']="Xestión do sitio de destino";
$string['setting_destiny_sites_desc']="Lista de sitios de destino, aos que se poden entregar copias de seguridade dos cursos. Realiza unha proba para comprobar que todo está configurado correctamente, tanto no destino como na orixe.";
...
$string['destiny_target_is_incorrect']="Destiny Target é incorrecto, debería ter valores 2,3 ou 4: --destiny_target=2";
$string['origin_course_id_integer']="O ID do curso de orixe debe ser enteiro: --origin_course_id=12";
$string['destiny_course_id_is_required']="O ID do curso de Destiny é necesario: --destiny_course_id=12";
$string['destiny_course_id_isnot_correct']="Para destiny_target=2 non debes ter un curso de destino, crearase un novo curso";
$string['destiny_category_id_integer']="O ID da categoría Destiny debe ser enteiro: --destiny_category_id=101";
$string['origin_enrolusers_boolean']="Os usuarios de rexistro de orixe deben ser booleanos: --origin_enrolusers=true";
$string['destiny_remove_enrols_boolean']="Os rexistros de eliminación de Destiny deben ser booleanos: --destiny_remove_enrols=false";
$string['destiny_remove_groups_booelan']="Os grupos de eliminación de Destiny deben ser booleanos: --destiny_remove_groups=false";
...
$string['destiny_not_remove_activities_invalid']="As actividades de Destiny Not Remove deben ser unha cadea cmid separada por comas de tipo matriz: --destiny_not_remove_activities=[3,234,234]";
...
$string['destiny_course_id']="ID do curso obxectivo";
...
$string['config_destiny_merge_activities']="Combina a copia de seguranza con este curso";
$string['config_destiny_remove_enrols']="Eliminar roles e matrículas no curso de destino";
$string['config_destiny_remove_groups']="Eliminar grupos e agrupacións no curso de destino";
$string['config_destiny_remove_activities']="Elimina o contido actual do curso e despois restaura";
...
$string['destiny_course_id_integer']="O ID do curso de destino debe ser enteiro";
$string['destiny_category_id_require']="É necesario o ID da categoría de destino";
$string['destiny_category_id_integer']="O ID da categoría de destino debe ser enteiro";
...
$string['deleteindestiny']="Eliminar no destino";
$string['config_destiny_merge_activities_desc']="As actividades do curso de orixe fusionaranse co curso de destino";
$string['config_destiny_remove_activities_desc']="Todo o contido do curso de destino eliminarase e restaurarase co curso de orixe";
$string['config_destiny_remove_groups_desc']="Eliminaranse todos os grupos e agrupacións existentes do curso de destino.";
$string['config_destiny_remove_enrols_desc']="Eliminaranse as inscricións e funcións actuais para o curso de destino que xa existan.";
...
$string['step2_course_destiny']="Curso Destino";
...
$string['step4_destiny_title']="Categoría obxectivo";
$string['step4_destiny_desc']="Seleccione a categoría de destino de restauración";
...
$string['destiny_site']="Sitio de destino";
$string['id']="ID";
...
$string['log_page_destiny_target']="Obxectivo de destino";
$string['log_page_petition_type']="Tipo de solicitude";
$string['log_page_direction']="Enderezo";
$string['log_page_destiny_request']="Solicitude de destino";
$string['log_page_request_category']="Categoría de solicitude";
$string['log_page_destiny_data']="Datos de destino";
...
$string['coursetransfer:destiny_restore_enrol_remove']="Eliminar roles e matrículas no curso de destino";
$string['coursetransfer:destiny_restore_groups_remove']="Eliminar grupos e agrupacións no curso de destino";
$string['coursetransfer:destiny_restore_content_remove']="Elimina o contido actual do curso e despois restaura";
$string['coursetransfer:destiny_restore_merge']="Combina a copia de seguranza con este curso";
