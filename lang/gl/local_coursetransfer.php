...
$string['target_target_is_incorrect'] = "Destiny Target é incorrecto, debería ter valores 2,3 ou 4: --target_target=2";
$string['origin_course_id_integer'] = "O ID do curso de orixe debe ser enteiro: --origin_course_id=12";
$string['target_course_id_is_required'] = "O ID do curso de Destiny é necesario: --target_course_id=12";
$string['target_course_id_isnot_correct'] = "Para target_target=2 non debes ter un curso de destino, crearase un novo curso";
$string['target_category_id_integer'] = "O ID da categoría Destiny debe ser enteiro: --target_category_id=101";
$string['origin_enrolusers_boolean'] = "Os usuarios de rexistro de orixe deben ser booleanos: --origin_enrolusers=true";
$string['target_remove_enrols_boolean'] = "Os rexistros de eliminación de Destiny deben ser booleanos: --target_remove_enrols=false";
$string['target_remove_groups_booelan'] = "Os grupos de eliminación de Destiny deben ser booleanos: --target_remove_groups=false";
...
$string['target_not_remove_activities_invalid'] = "As actividades de Destiny Not Remove deben ser unha cadea cmid separada por comas de tipo matriz: --target_not_remove_activities=[3,234,234]";
