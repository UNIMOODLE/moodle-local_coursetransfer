...
use local_coursetransfer\tables\logs_course_remove_request_table;
use moodle_exception;
use moodle_url;

/**
 * logs_course_remove_request_page
 *
 * @package    local_coursetransfer
 * @copyright  2023 3iPunt {@link https://tresipunt.com/}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class logs_course_remove_request_page extends logs_page {
    ...
    public function __construct() {
        parent::__construct();
        $uniqid = uniqid('', true);
        $this->table = new logs_course_remove_request_table($uniqid);
