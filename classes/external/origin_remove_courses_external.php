...
class origin_remove_courses_external extends external_api {

    /**
     * @return external_function_parameters
     */
    public static function origin_remove_courses_step1_parameters(): external_function_parameters {
     ...
     */
    public static function origin_remove_courses_step1(int $siteurl): array {
        self::validate_parameters(
            self::origin_remove_courses_step1_parameters(),
            [
                'siteurl' => $siteurl,
            ]
        );
     ...
     */
    public static function origin_remove_courses_step1_returns(): external_single_structure {
