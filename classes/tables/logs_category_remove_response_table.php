...
/**
 * Class logs_category_remove_response_table
 *
 * @package    local_coursetransfer
 * @copyright  2023 3iPunt {@link https://tresipunt.com/}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class logs_category_remove_response_table extends table_sql {
    ...
    public function col_origin_category_id(stdClass $row): string {
        return '[' . $row->origin_category_id . '] ' . $row->origin_category_name;
    }
